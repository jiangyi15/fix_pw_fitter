...
# Dataset 1
start = time.time()
Q1, grads1, P1 = kernel.compute(params, holder1)
time1 = time.time() - start
print(f"\nDataset 1: Q = {Q1:.6f}, Time = {time1*1000:.2f}ms")

# Dataset 2
start = time.time()
Q2, grads2, P2 = kernel.compute(params, holder2)
time2 = time.time() - start
print(f"Dataset 2: Q = {Q2:.6f}, Time = {time2*1000:.2f}ms")

# Dataset 3
start = time.time()
Q3, grads3, P3 = kernel.compute(params, holder3)
...
print("="*70)
start = time.time()
Q1_again, _, _ = kernel.compute(params, holder1)
...
Q1_mod, grads1_mod, _ = kernel.compute(params_modified, holder1)
...
Q2_same, grads2_same, _ = kernel.compute(params_modified, holder2)
...
Q1_final, _, _ = kernel.compute(params, holder1)
