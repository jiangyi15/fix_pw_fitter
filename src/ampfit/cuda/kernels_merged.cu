...
// Structs for unified launch API (Python fills via CFFI)
typedef struct {
...
void launch_compute_all(
    ...
    launch_gradient_merged(
        ...
        d->Gamma, d->Delta_Gamma, d->Delta_m,
        d->A_prod, d->poq_rho, d->pop_phi,
        dim->n_wave, dim->n_res, dim->n_unique_bw, dim->n_total_positions,
        dim->n_gamma_rows, dim->n_mass,
