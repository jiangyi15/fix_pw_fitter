...
CLI (write an ``.npz`` file)::
    ...
    python -m tabpwa.phasespace_b4pi -n 200000 -o phsp_b4pi.npz
"""
...
def build_momenta(m1, m2, ct1, ct2, phi, m_B=M_B_MESON, m_pi=M_PION,
    ...
    q_B : ndarray (n,), optional
        ...
        ``q(m_B; m₁, m₂)`` (lets :func:`tabpwa.momenta_to_data.
    ...
    :func:`tabpwa.momenta_to_data.data_to_momentum` (row-0 kinematics).
    """
