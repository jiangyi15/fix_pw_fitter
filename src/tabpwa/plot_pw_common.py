...
from tabpwa.plot_pw_groups import PWGroupPlotter, plot_samesign
...
def plot_common(plotter, fitter, output="plots/", fmt="png"):
    ...
    Args:
        plotter: a computed :class:`~tabpwa.plot_pw_groups.PWGroupPlotter`.
        fitter: the :class:`~tabpwa.Fitter` holding the data.
