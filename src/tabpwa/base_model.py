...
:class:`BaseModel` is the interpreted physics: the :class:`~tabpwa.decay_tree.DecayTree`,
...
``Config`` (in :mod:`tabpwa.config_loader`) owns the raw input and subclasses
...
class BaseModel:
    ...
    def _barrier(self, decay, L):
        ...
        """
        from tabpwa.bw_form_factor import DEFAULT_BARRIER, build_barrier
        from .build_defaults import get as _build_get
    ...
    def build_fl_table(self, forms, n_interp=None):
        ...
        *forms* is the ordered list of unique barrier instances
        (:class:`~tabpwa.bw_form_factor.BarrierFactor`); a bare ``L`` is
        ...
        """
        from tabpwa.bw_form_factor import BarrierFactor, build_barrier
        from .build_defaults import get as _build_get
    ...
    def _helicity_top_states(self):
        ...
        if getattr(self, "angle_formula_mode", "helicity") != "helicity":
            return [0]
        from tabpwa.helicity_angle import to_spin
    ...
    def _wave_angle_terms(self, decaychain, ls, lam):
        ...
        from fractions import Fraction
        from tabpwa.helicity_angle import (
    ...
    def build_single_index(self):
        ...
        * helicity mode with a spinful top: one *distinct* p-major column
        ...
        try:
            from tabpwa.helicity_angle import (decay_chain_to_tree,
