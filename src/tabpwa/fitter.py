...
class Fitter:
    ...
    def __init__(self, config_file="config_angle.yml", backend=None):
        ...
        from tabpwa.backends import (create_backend, resolve_backend_spec,
                                     backends_for_model)
    ...
    def add_prior(self, prior):
        ...
        Args:
            prior: A :class:`~tabpwa.param_constraint.Prior` instance.
    ...
    @property
    def pc(self):
        """The :class:`~tabpwa.param_constraint.CKProduct` for CK combinatorics."""
    ...
    @property
    def decay_tree(self):
        """The interpreted :class:`~tabpwa.decay_tree.DecayTree`.
    ...
    def load_constraints(self, filepath):
        ...
        """
        import json
        from tabpwa.param_constraint import prior_from_dict, transform_from_dict
