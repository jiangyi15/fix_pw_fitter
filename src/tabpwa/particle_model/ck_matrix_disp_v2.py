...
from tabpwa.param_constraint import Transform, complex_tail, phase_name
...
class CKMatrixDispModelV2(BaseModel):
    ...
    # get_gamma_name() (the CK re/im names) and computes the peak
    # mass / width from the running gamma.
