...
def samesign_varfun(x):
    ...
    Reconstructs the momenta with :func:`tabpwa.momenta_to_data.
    data_to_momentum` (row-0 = the generator's ρρ parametrisation) and
    reads the B → (π⁺₁π⁺₂)(π⁻₁π⁻₂) kinematics with
    :func:`tabpwa.momenta_to_data.momenta_to_data_samesign`:
    ...
    """
    from tabpwa.momenta_to_data import (data_to_momentum,
