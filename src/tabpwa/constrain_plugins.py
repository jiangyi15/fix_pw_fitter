...
def _handle_mass_width_bw(fitter, spec):
    ...
    :class:`~tabpwa.param_constraint.BWParamsTransform` and Gaussian
    ...
    """
    from tabpwa.param_constraint import BWParamsTransform, GaussianPrior
...
def _handle_transforms(fitter, spec):
    ...
    lookups.
    """
    from tabpwa.param_constraint import transform_from_dict
    for item in spec:
